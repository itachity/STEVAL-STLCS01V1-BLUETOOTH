...
/* Make this header self-contained: it declares prototypes that use the
 * fixed-width integer types and the BlueNRG tBleStatus typedef. Pulling
 * <stdint.h> and bluenrg_types.h here means downstream files don't have
 * to remember to include them in any particular order. */
#include <stdint.h>
